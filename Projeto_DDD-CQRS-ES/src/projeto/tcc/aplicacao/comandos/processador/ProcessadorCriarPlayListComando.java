...
//		PosProcessadorComandos.validaVersaoComando(comando);
		...
		eventoProcessador.processarEvento((new PlayListAdicionadaEvento(criarPlayListComando.aggregateId(),criarPlayListComando.getPlayListUID(), criarPlayListComando.getNome(), 0L)));
